...
function getBatchExpiryStatus(expDate: string): { label: string; cls: string } {
  ...
  return { label: "Active", cls: "text-emerald-700 bg-emerald-50 border-emerald-200" };
}
              ...
              {loadingCatalog ? (
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-slate-500">{item.minStockLevel} {item.unit}</td>
                    <td className="py-3 px-4">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-slate-50 border border-slate-200/80">
                  ...
                  <div>
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Low Stock Threshold</span>
                    <span className="text-xl font-bold text-slate-800 mt-1 block">
                      {viewingItem.minStockLevel} <span className="text-xs font-normal text-slate-500">{viewingItem.unit}</span>
                    </span>
                  </div>
                  <div>
                  ...
                  {loadingBatches ? (
                    ...
                    <div className="rounded-xl border border-dashed border-slate-200 p-8 text-center bg-slate-50/50">
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        Batches and stock are automatically created when recording purchase deliveries in the Purchase page.
                      </p>
                    </div>
                  ) : (
              ...
              <div className="flex-1 space-y-6 overflow-y-auto p-8">
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <Field label="HSN Code">
                    <TextInput value={form.hsnCode} onChange={v => setField("hsnCode", v)} placeholder="e.g. 3004" />
                  </Field>
                  <Field label="Unit">
                    <CreatableSelect
                  ...
                  <Field label="Low Stock Threshold" hint="Item is flagged “Low Stock” at or below this quantity" span>
                    <NumInput value={form.minStockLevel} onChange={v => setField("minStockLevel", v)} />
                  </Field>
